                ...
                <div className="carousel">
                    ...
                    <figure className="carousel_slide carousel_slide-2">
                        <div className="slide_content">
                            ...
                            <div className="connectCardCont push-xl-2 push-md-1">
                                <img src="img/business-card.jpg" className="connect_cadrd" alt="card" />
                            </div>
                            ...
                            <Col md={{ span: 6, offset: 6 }} className="social-icons-cont">
                                <ul className="social-icons-list">
                                    ...
                                    <li>
                                        <span className="gh">
                                            <img src="img/icon-gh.png" alt="Icon" />
                                        </span>
                    ...
                    <figure className="carousel_slide carousel_slide-5">
                        <img src="img/new%20york.jpg" alt="New York" />
                    </figure>
